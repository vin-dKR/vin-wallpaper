...
import { generateImageWithGemini, generateRandomImageWithGemini } from '@/actions/gemini-actions';

interface GeminiImageGeneratorProps {
    className?: string;
}

export function GeminiImageGenerator({ className = '' }: GeminiImageGeneratorProps) {
    ...
    const handleGenerateRandom = async () => {
        ...
        try {
            const result = await generateRandomImageWithGemini();
    ...
    const handleDownload = () => {
        ...
        link.download = `gemini-wallpaper-${Date.now()}.jpg`;
        ...
        <div className={`bg-white rounded-lg shadow-lg p-6 ${className}`}>
            <div className="text-center mb-6">
                ...
                <p className="text-gray-600">
                    Generate beautiful wallpapers using Google's Gemini AI
                </p>
            </div>
            ...
            {isGenerating && (
                <div className="text-center py-8">
                    ...
                    <p className="mt-2 text-gray-600">Generating your wallpaper...</p>
                </div>
            )}
        </div>
    );
