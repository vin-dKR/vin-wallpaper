...
const CTADetails = () => {
    return (
        <div className="mt-40">
            ...
            <div className="relative bg-gradient-to-b from-blue-800 to-white rounded-4xl">
                <div className="relative mt-10 h-200 rounded-4xl overflow-hidden border-2 border-black/10 md:border-black/10">
                    ...
                    <div className="relative z-20 h-full">
                        <div className="grid grid-cols-1 md:grid-cols-3 px-2 md:px-10 py-10 md:py-20 h-full">
                            <div className="col-span-2 py-10 md:py-20 px-10 md:px-30">
                                ...
                                <p className="text-xl text-white md:text-3xl mt-10 md:mt-20 text-shadow-md">We handle everything. All you need is your 𝕏 API Token & Secret Key — you&apos;re good to go.</p>
