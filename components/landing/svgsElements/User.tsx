    ...
    return (
        <div>
            <svg width="50" height="58" viewBox="0 0 50 58" fill="none" xmlns="http://www.w3.org/2000/svg" >
                <rect x="0.746338" y="4" width="49.2537" height="49.2537" rx="11.0035" fill="url(#paint0_linear_21_121)" />
                <foreignObject
                    x="-100.381"
                    y="-97.1273"
                    width="251.508"
                    ...
                    <div
                        style={{
                            ...
                            clipPath: "url(#bgblur_0_21_121_clip_path)",
                            height: "100%",
                            width: "100%"
                        }}>
                    </div>
                </foreignObject>
                <g filter="url(#filter0_d_21_121)" data-figma-bg-blur-radius="104.795">
                    <rect x="4.41418" y="7.66783" width="41.918" height="41.918" rx="7.33566" fill="url(#paint1_linear_21_121)" />
                </g>
                <g filter="url(#filter1_f_21_121)">
